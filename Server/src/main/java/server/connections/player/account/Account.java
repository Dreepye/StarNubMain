...
import server.connections.player.groups.GroupAssignment;
import server.connections.player.groups.GroupInheritance;
 ...
 * <p>
 * When a player logs into the starbounddata.packets.starbounddata.packets.server, that is a character the {@link server.connections.player.character.Character}
 * class represents this that character gets attached to a {@link server.connections.player.session.Player} session, the Player
 ...
 * then hold their personal starbounddata.packets.starbounddata.packets.server settings and preferences, like ignore list, starbounddata.packets.chat rooms they were in, ect ect. This Account class
...
public class Account {
    ...
    @ForeignCollectionField(eager = true, columnName = "GROUP_ASSIGNMENTS")
    private volatile ForeignCollection<server.connections.player.character.Character> characters;
     ...
     * <p>
     * Lets take the above commands and a few more and show that the tree would look like. starbound.kick.kick, starbound.admin.broadcast,
     * starbound.admin.killplayer, someplugin.chatness.chatcolors
     * starnub -|
     ...
     *          starnub.starbounddata.packets.starbounddata.packets.server.shutdown
     *          starnub.starbounddata.packets.starbounddata.packets.server.start
     *          starnub.starbounddata.packets.starbounddata.packets.server.*
     *          starnub.*
     * <br>
     * The first line would give me shutdown. The second line would be start. The third line give me anything under
     * starnub.starbounddata.packets.starbounddata.packets.server The fourth line gives me all permissions for the starnub plugin.
     *
     * <p>
