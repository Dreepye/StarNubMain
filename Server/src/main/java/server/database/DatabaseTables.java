...
import server.connections.player.account.*;
import server.connections.player.achievements.Achievement;
import server.connections.player.achievements.CharacterAchievement;
import server.connections.player.character.CharacterIP;
import server.connections.player.groups.*;
...
public enum DatabaseTables {
    ...
    public void setTableWrappers(){
        ...
        characters = new Characters(connection, 0, server.connections.player.character.Character.class, Integer.class);
