...
public class StarboundQueryTaskEvent extends TaskEvent {
    ...
    /**
     * Sent when the server query task has started. This is used to set a status on
     * {@link org.starnub.server.server.starbound.StarboundManager} this prevents the methods
    ...
    /**
     * Sent when the server query task is running. This is used to set a status on
     * {@link org.starnub.server.server.starbound.StarboundManager} this prevents the methods
    ...
    /**
     * Sent when the server query task has completed and the methods on
     * {@link org.starnub.server.server.starbound.StarboundManager} are available for use
     */
