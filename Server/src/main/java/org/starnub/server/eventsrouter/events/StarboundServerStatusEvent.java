...
public class StarboundServerStatusEvent extends StatusEvent {
    ...
    /**
     * boolean representing that the Starbound server process status
     */
    @Getter
    private volatile boolean crashed;

    /**
     * boolean representing that the Starbound server is responsive
     */
    @Getter
    private volatile boolean unresponsive;

    /**
     * boolean represents if the server is restarting
     */
    @Getter
     ...
     * @param online       boolean setting if the server is online
     */
    ...
    /**
     * Sent when the server check detects a crashed process
     */
    ...
    /**
     * Sent when the server tcp query returns unresponsive after 12 query attempts over 120 seconds
     */
    ...
    /**
     * Sent when the server is just starting up
     */
    ...
    /**
     * Sent periodically while the server is still starting up
     */
    ...
    /**
     * Sent once the server is online
     */
    ...
    /**
     * Sent when the server has responded to a process check and TCP query
     */
    ...
    /**
     * Sent when the server was signaled to shutdown
     */
    ...
    /**
     * Sent when the server has shutdown
     */
    ...
    /**
     * Sent every time the server query attempt has failed.
     *
