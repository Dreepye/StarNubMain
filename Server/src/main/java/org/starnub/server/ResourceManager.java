...
//                "Resources",
    ...
    protected void resourceExtraction() {
        ...
        if (!snConf.exists()) {
            fileExtraction("org/starnub/server/fileextracts/default_configuration.yml", "StarNub/starnub_config.yml", false);
        ...
        Map<String, Object> configurationValues = new YamlLoader().resourceYamlLoader("org/starnub/server/resources.yml");
