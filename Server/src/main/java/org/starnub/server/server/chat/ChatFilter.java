...
public enum ChatFilter {
    ...
    public void loadIllegalNicks(){
        ...
        boolean addGroups = ((boolean) ((Map)StarNub.getConfiguration().getConfiguration().get("server chat")).get("global_add_groups_illegal_nicks"));
        boolean addTags = ((boolean) ((Map)StarNub.getConfiguration().getConfiguration().get("server chat")).get("global_add_tags_illegal_nicks"));
