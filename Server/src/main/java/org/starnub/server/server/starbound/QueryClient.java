 ...
 * to elicit a response from the server. If responsive
...
class QueryClient {
    ...
    /**
     * This method actually opens a connection to the Starbound Server
...
//                                       System.out.println(versionNumber);
                                                       ...
                                                       public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
                                                           StarNub.getLogger().cFatPrint("StarNub", "Error in Query Packet Decoder Handler.");
