...
public class Restrictions {
    ...
    /**
     * Represents if the restriction includes a mute from chat
     */
    @Getter
    ...
    /**
     * Represents if the restriction includes a ban from the server
     */
    @Getter
    ...
    /**
     * This method is the master restriction setter. Used in the {@link org.starnub.server.server.Connections} enum
     * singleton.
     * @param restrictedIdentifier String Represents the restrictedIdentifier which can be a IP or UUID
