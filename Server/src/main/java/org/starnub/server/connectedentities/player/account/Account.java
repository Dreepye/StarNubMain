...
import org.starnub.server.connectedentities.player.groups.GroupInheritance;
 ...
 * <p>
 * When a player logs into the server, that is a character the {@link org.starnub.server.connectedentities.player.character.Character}
 * class represents this that character gets attached to a {@link org.starnub.server.connectedentities.player.session.Player} session, the Player
 ...
 * then hold their personal server settings and preferences, like ignore list, chat rooms they were in, ect ect. This Account class
...
public class Account {
    ...
    @Getter
    @ForeignCollectionField(eager = true, columnName = "GROUP_ASSIGNMENTS")
    private volatile ForeignCollection<Character> characters;
     ...
     * starnub.server The fourth line gives me all permissions for the starnub plugin.
     *
     * <p>
