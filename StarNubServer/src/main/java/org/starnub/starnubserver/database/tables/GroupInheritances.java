...
import org.starnub.starnubserver.connections.player.groups.GroupInheritance;
...
public class GroupInheritances extends TableWrapper<GroupInheritance, Integer> {
    ...
    private GroupInheritances(){
        super(DatabaseConnection.getInstance().getStarnubConnection(), 0, GroupInheritance.class, Integer.class);
    }
