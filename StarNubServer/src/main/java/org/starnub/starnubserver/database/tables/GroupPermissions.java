...
import org.starnub.starnubserver.connections.player.groups.GroupPermission;
...
public class GroupPermissions extends TableWrapper<GroupPermission, Integer> {
    ...
    private GroupPermissions(){
        super(DatabaseConnection.getInstance().getStarnubConnection(), 0, GroupPermission.class, Integer.class);
    }
