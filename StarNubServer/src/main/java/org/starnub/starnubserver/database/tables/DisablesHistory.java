...
import org.starnub.starnubserver.connections.player.generic.DisabledHistory;
...
public class DisablesHistory extends TableWrapper<DisabledHistory, String> {
    ...
    private DisablesHistory(){
        super(DatabaseConnection.getInstance().getStarnubConnection(), 0, DisabledHistory.class, String.class);
    }
