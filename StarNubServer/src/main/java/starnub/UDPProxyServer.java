...
final class UDPProxyServer implements Runnable {
    ...
    public void run() {
		...
		/* Buffers for receive request and return the real starbounddata.packets.starbounddata.packets.starnub answer. */
        ...
        while (true) {
            try {
				...
				/* (2) sending the received data to the starbounddata.packets.starbounddata.packets.starnub */
				...
				/* (3) reading the starbounddata.packets.starbounddata.packets.starnub answer */
