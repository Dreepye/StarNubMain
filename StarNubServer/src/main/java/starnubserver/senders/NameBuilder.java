...
//     *                         at {@link starnubserver.network.Connectionss} under method PlayerByAnyIdentifier.
...
//        Player playerReceiver = StarNub.getStarboundServer().getConnectionss().getOnlinePlayerByAnyIdentifier(playerReceiverIdentifier);
//        if (playerReceiver == null) {
//            playerNotFoundMsg(sender);
//            return false;
//        }
//        Player playerSender = StarNub.getStarboundServer().getConnectionss().getOnlinePlayerByAnyIdentifier(sender);
...
//        Connectionss con = StarNub.getStarboundServer().getConnectionss();
//        if (!con.hasPermission(playerSender, "starnubinternals.starbounddata.packets.starbounddata.packets.starnubserver.whisper", true)) {
//            playerMessage("StarNub", playerSender, ChatReceivePacket.ChatReceiveChannel.UNIVERSE, "You do not have the permission \"starnubserver.starbounddata.packets.starbounddata.packets.starnubserver.whisper\" you cannot whisper.");
//            return false;
//        }
...
//     * can be turned off, while failed commands will not be able to be disabled by starnubserver owners.
//     * <p>
//     *
...
//     * Recommended: For internal use with StarNub.
//     * <p>
//     * Uses: This is used to send a message to the console or a management starnubclient
//     * <p>
//     *
//     * @param sender  Object which represents the message sender can be a string, class, player, management starnubclient
//     * @param message String the message to be sent to the management starnubclient
//     */
//    private void nonPlayerCommandResult(Object sender, String message, boolean success) {
//         if (sender instanceof String) {
//            if (((String) sender).equalsIgnoreCase("sn") || ((String) sender).equalsIgnoreCase("starnubserver")) {
//                if (success) {
...
//     * Recommended: For Plugin Developers & Anyone else.
//     * <p>
//     * Uses: This is used to send a message to the starnubserver on a specified player channel. This method is useful
...
//     * @param message        message to be sent to the starbounddata.packets.starbounddata.packets.starnubserver
//     */
...
//                StarNub.getStarboundServer().getConnectionss().getConnectedPlayers(),
