 ...
 * the {@link starbounddata.types.color.Colors} class
 * <p>
 *
...
public enum Colors {
     ...
     * Recommended: For Plugin Developers & Anyone else.
     * <p>
     * Uses: This method will create a HashSet of {@link starbounddata.types.color.Color}'s to be returned to the calling code
     * <p>
     * Note: {@link starbounddata.types.color.Color} represents a Starbound Color by Name, Hex and StarNub shortcut
     *
     * @return HashSet representing all of the {@link starbounddata.types.color.Color}'s available
     */
     ...
     * <p>
     * Uses: This method will create a new Color using the enumeration {@link starbounddata.types.color.Color}
     * <p>
     * Note: {@link starbounddata.types.color.Color} represents a Starbound Color by Name, Hex and StarNub shortcut
     *
     ...
     * Recommended: For Plugin Developers & Anyone else.
     * <p>
     * Uses: This method will create a HashSet of {@link starbounddata.types.color.Color}'s to be returned to the calling code based on a provided search term.
     ...
     * @return HashSet representing all of the found {@link starbounddata.types.color.Color}'s
     */
