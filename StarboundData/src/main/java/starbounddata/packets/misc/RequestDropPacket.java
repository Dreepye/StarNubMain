 ...
 * <p>
 *
 * This is sent to request a item pickup
 *
...
public class RequestDropPacket extends Packet {
    ...
    private EntityVLQId dropEntityId = new EntityVLQId();
     ...
     */
    public RequestDropPacket(Direction DIRECTION, ChannelHandlerContext SENDER_CTX, ChannelHandlerContext DESTINATION_CTX) {
        super(DIRECTION, Packets.REQUESTDROP.getPacketId(), SENDER_CTX, DESTINATION_CTX);
    }
     ...
     * @param dropEntityId
     */
    public RequestDropPacket(EntityVLQId dropEntityId) {
        super(Packets.REQUESTDROP.getDirection(), Packets.REQUESTDROP.getPacketId());
        this.dropEntityId = dropEntityId;
    }
     ...
     */
    public RequestDropPacket(RequestDropPacket packet) {
        super(packet);
    }

    public EntityVLQId getDropEntityId() {
        return dropEntityId;
    }

    public void setDropEntityId(EntityVLQId dropEntityId) {
        this.dropEntityId = dropEntityId;
    }
     ...
     */
    @Override
    public RequestDropPacket copy() {
        return new RequestDropPacket(this);
    }
    ...
    public void write(ByteBuf out) {
        this.dropEntityId.write(out);
    }

    @Override
    public String toString() {
        return "RequestDropPacket{" +
