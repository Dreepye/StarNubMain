...
public class DamageRequestPacket extends Packet {
     ...
     * @param DESTINATION_CTX ChannelHandlerContext which represents the destination of this packets context (Context can be written to)
     */
    public DamageRequestPacket(Packet.Direction DIRECTION, ChannelHandlerContext DESTINATION_CTX) {
        super(DIRECTION, Packets.DAMAGEREQUEST.getPacketId(), DESTINATION_CTX);
    }
     ...
     * <p>
     * @param remoteDamageRequest
     */
    public DamageRequestPacket(RemoteDamageRequest remoteDamageRequest) {
        super(Packets.DAMAGEREQUEST.getDirection(), Packets.DAMAGEREQUEST.getPacketId());
