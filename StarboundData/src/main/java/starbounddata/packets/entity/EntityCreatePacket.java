...
public class EntityCreatePacket extends Packet {
    ...
    public EntityCreatePacket(ChannelHandlerContext DESTINATION_CTX, EntityType entityType, byte[] storeData, EntityVLQId entityId) {
        super(Packets.ENTITYCREATE.getDirection(), Packets.ENTITYCREATE.getPacketId(), DESTINATION_CTX);
     ...
     * @param entityId
     */
    public EntityCreatePacket(EntityType entityType, byte[] storeData, EntityVLQId entityId) {
        super(Packets.ENTITYCREATE.getDirection(), Packets.ENTITYCREATE.getPacketId());
        this.entityType = entityType;
        this.storeData = storeData;
        this.entityId = entityId;
    }
    ...
    public void write(ByteBuf out) {
        ...
        writeVLQArray(out, storeData);
        this.entityId.write(out);
        System.err.println(out.readableBytes());
    }
