...
public class HandshakeResponsePacket extends Packet {
     ...
     */
    public HandshakeResponsePacket(Direction DIRECTION, ChannelHandlerContext SENDER_CTX, ChannelHandlerContext DESTINATION_CTX) {
        super(DIRECTION, Packets.HANDSHAKERESPONSE.getPacketId(), SENDER_CTX, DESTINATION_CTX);
    }
     ...
     */
    public HandshakeResponsePacket(HandshakeResponsePacket packet) {
        super(packet);
        this.passwordHash = packet.getPasswordHash();
    }
     ...
     */
    @Override
    public HandshakeResponsePacket copy() {
    ...
    public void read(ByteBuf in) {
        this.passwordHash = readVLQArray(in);
    }
    ...
    public void write(ByteBuf out) {
        writeVLQArray(out, this.passwordHash);
    }
