...
public class OpenContainerPacket extends Packet {
    ...
    public OpenContainerPacket(ChannelHandlerContext DESTINATION_CTX, EntityVLQId containerId) {
        super(Packets.OPENCONTAINER.getDirection(), Packets.OPENCONTAINER.getPacketId(), DESTINATION_CTX);
     ...
     * @param containerId
     */
    public OpenContainerPacket(EntityVLQId containerId) {
        super(Packets.OPENCONTAINER.getDirection(), Packets.OPENCONTAINER.getPacketId());
        this.containerId = containerId;
    }
