...
public class StartCraftingInContainerPacket extends Packet {
     ...
     */
    public StartCraftingInContainerPacket(Direction DIRECTION, ChannelHandlerContext SENDER_CTX, ChannelHandlerContext DESTINATION_CTX) {
        super(DIRECTION, Packets.STARTCRAFTINGINCONTAINER.getPacketId(), SENDER_CTX, DESTINATION_CTX);
    }
     ...
     * @param containerId
     */
    public StartCraftingInContainerPacket(EntityVLQId containerId) {
        super(Packets.STARTCRAFTINGINCONTAINER.getDirection(), Packets.STARTCRAFTINGINCONTAINER.getPacketId());
     ...
     */
    public StartCraftingInContainerPacket(StartCraftingInContainerPacket packet) {
        super(packet);
    }
     ...
     */
    @Override
    public StartCraftingInContainerPacket copy() {
        return new StartCraftingInContainerPacket(this);
    }
    ...
    public String toString() {
        return "StartCraftingInContainerPacket{" +
