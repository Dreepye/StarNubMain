...
public class CloseContainerPacket extends Packet {
     ...
     * @param
     */
    public CloseContainerPacket(ChannelHandlerContext DESTINATION_CTX, EntityVLQId containerId) {
        super(Packets.CLOSECONTAINER.getDirection(), Packets.CLOSECONTAINER.getPacketId(), null, DESTINATION_CTX);
