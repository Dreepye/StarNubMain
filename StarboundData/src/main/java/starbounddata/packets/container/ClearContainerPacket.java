...
/**
 * Represents the ClearContainerPacket and methods to generate a packet data for StarNub and Plugins
 * <p>
 ...
 *
 * This loots all contents of a container
 *
...
public class ClearContainerPacket extends Packet {
     ...
     */
    public ClearContainerPacket(Direction DIRECTION, ChannelHandlerContext SENDER_CTX, ChannelHandlerContext DESTINATION_CTX) {
        super(DIRECTION, Packets.CLEARCONTAINER.getPacketId(), SENDER_CTX, DESTINATION_CTX);
    }
     ...
     * @param containerId
     */
    public ClearContainerPacket(ChannelHandlerContext DESTINATION_CTX, EntityVLQId containerId) {
        super(Packets.CLEARCONTAINER.getDirection(), Packets.CLEARCONTAINER.getPacketId(), DESTINATION_CTX);
     ...
     * @param containerId
     */
    public ClearContainerPacket(EntityVLQId containerId) {
        super(Packets.CLEARCONTAINER.getDirection(), Packets.CLEARCONTAINER.getPacketId());
        this.containerId = containerId;
    }
     ...
     */
    public ClearContainerPacket(ClearContainerPacket packet) {
        super(packet);
    }
     ...
     */
    @Override
    public ClearContainerPacket copy() {
        return new ClearContainerPacket(this);
    }
