...
public class BurnContainerPacket extends Packet {
     ...
     */
    public BurnContainerPacket(Direction DIRECTION, ChannelHandlerContext SENDER_CTX, ChannelHandlerContext DESTINATION_CTX) {
        super(DIRECTION, Packets.BURNCONTAINER.getPacketId(), SENDER_CTX, DESTINATION_CTX);
    }
     ...
     * @param containerId
     */
    public BurnContainerPacket(EntityVLQId containerId) {
        super(Packets.BURNCONTAINER.getDirection(), Packets.BURNCONTAINER.getPacketId());
     ...
     */
    public BurnContainerPacket(BurnContainerPacket packet) {
        super(packet);
    }
     ...
     */
    @Override
    public BurnContainerPacket copy() {
        return new BurnContainerPacket(this);
    }
