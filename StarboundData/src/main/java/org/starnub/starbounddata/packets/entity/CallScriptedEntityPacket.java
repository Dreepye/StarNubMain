...
import org.starnub.starbounddata.types.variants.VariantList;
...
public class CallScriptedEntityPacket extends Packet {
     ...
     * @param args
     */
    public CallScriptedEntityPacket(EntityVLQId entityId, String function, VariantList args){
        super(Packets.CALLSCRIPTEDENTITY.getDirection(), Packets.CALLSCRIPTEDENTITY.getPacketId());
