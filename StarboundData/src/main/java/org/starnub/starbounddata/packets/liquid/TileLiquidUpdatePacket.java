...
import org.starnub.starbounddata.types.liquid.LiquidNetUpdate;
...
public class TileLiquidUpdatePacket extends Packet {
     ...
     * <p>
     * @param tilePosition
     * @param liquidNetUpdate
     */
    public TileLiquidUpdatePacket(Vec2I tilePosition, LiquidNetUpdate liquidNetUpdate) {
        super(Packets.TILELIQUIDUPDATE.getDirection(), Packets.TILELIQUIDUPDATE.getPacketId());
