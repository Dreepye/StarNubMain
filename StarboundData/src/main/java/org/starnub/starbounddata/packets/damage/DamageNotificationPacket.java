...
package org.starnub.starbounddata.packets.damage;

import io.netty.buffer.ByteBuf;
import io.netty.channel.ChannelHandlerContext;
import org.starnub.starbounddata.ByteBufferUtilities;
import org.starnub.starbounddata.packets.Packets;
import org.starnub.starbounddata.types.damage.RemoteDamageNotification;
...
public class DamageNotificationPacket extends Packet {
     ...
     * <p>
     * @param remoteDamageNotification
     */
    public DamageNotificationPacket(RemoteDamageNotification remoteDamageNotification) {
        super(Packets.DAMAGENOTIFICATION.getDirection(), Packets.DAMAGENOTIFICATION.getPacketId());
    ...
    public void read(ByteBuf in) {
        ...
        this.remoteDamageNotification.read(in);
    }
    ...
    public void write(ByteBuf out) {
        this.remoteDamageNotification.write(out);
    }
