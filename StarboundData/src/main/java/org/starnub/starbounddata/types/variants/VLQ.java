...
package org.starnub.starbounddata.types.variants;
...
public class VLQ {
     ...
     * <p>
     * Uses: This will created a s{@link VLQ} from a {@link io.netty.buffer.ByteBuf}
     * <p>
     * Notes: This will create a VLQ object and SHOULD NOT be used when possible
     * <p>
     *
     * @param in ByteBuf in which is to be read
     * @return VLQ which represent how many reason bytes exist after the {@link VLQ}
     */
     ...
     * Recommended: For Plugin Developers & Anyone else.
     * <p>
     * Uses: This will created a u{@link VLQ} from a {@link io.netty.buffer.ByteBuf}
     * <p>
     * Notes: This will create a VLQ object and SHOULD NOT be used when possible
     * <p>
     *
     * @param in ByteBuf in which is to be read
     * @return VLQ which represent how many reason bytes exist after the {@link VLQ}
     * @throws IndexOutOfBoundsException if the {@link VLQ} ran out of bytes while reading
     */
     ...
     * Recommended: For Plugin Developers & Anyone else.
     * <p>
     * Uses: This will read a s{@link VLQ} from a {@link io.netty.buffer.ByteBuf}
     * <p>
     ...
     * Recommended: For Plugin Developers & Anyone else.
     * <p>
     * Uses: This will read a u{@link VLQ} from a {@link io.netty.buffer.ByteBuf}
     * <p>
     * Notes: This will not create a VLQ object and should be used
     * <p>
     *
     ...
     * Recommended: For Plugin Developers & Anyone else.
     * <p>
     * Uses: This will created a s{@link VLQ} from a long
     * <p>
     * Notes: This will create a VLQ object and SHOULD NOT be used when possible
     * <p>
     *
     ...
     * Recommended: For Plugin Developers & Anyone else.
     * <p>
     * Uses: This will created a u{@link VLQ} from a long
     * <p>
     * Notes: This will create a VLQ object and SHOULD NOT be used when possible
     * <p>
     *
