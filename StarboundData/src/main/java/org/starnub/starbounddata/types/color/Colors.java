...
//PLAIN COLOR
     ...
     * Recommended: For Plugin Developers & Anyone else.
     * <p>
     * Uses: This method will create a HashSet of {@link Color}'s to be returned to the calling code
     * <p>
     * Note: {@link Color} represents a Starbound Color by Name, Hex and StarNub shortcut
     *
     * @return HashSet representing all of the {@link Color}'s available
     */
     ...
     * <p>
     * Uses: This method will create a new Color using the enumeration {@link Color}
     * <p>
     * Note: {@link Color} represents a Starbound Color by Name, Hex and StarNub shortcut
     *
     ...
     * Recommended: For Plugin Developers & Anyone else.
     * <p>
     * Uses: This method will create a HashSet of {@link Color}'s to be returned to the calling code based on a provided search term.
     ...
     * @return HashSet representing all of the found {@link Color}'s
     */
