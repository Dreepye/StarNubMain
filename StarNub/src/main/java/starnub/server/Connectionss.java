...
import starnub.server.packets.Packet;
import starnub.server.packets.connection.ClientConnectPacket;
import starnub.server.packets.connection.ClientDisconnectRequestPacket;
import starnub.server.packets.connection.ConnectResponsePacket;
import starnub.server.packets.connection.ServerDisconnectPacket;
 ...
 * <p>
 * The data in this represents a pending player starbounddata.packets.connection, connect player, whitelist and
 * restrictions uuid's and IP's.
 *
 * @author Daniel (Underbalanced) (www.StarNub.org)
 * @since 1.0
 */
public enum Connectionss {
    INSTANCE;
...
//opslist
     ...
     * the values for pending connections, connect players, restrictions ips, restrictions uuids
     * and the starbounddata.packets.starbounddata.packets.starnub whitelist if they are null. Else they cannot be reset. After this we
     * will load the whitelist as well as the restrictions ip/uuid lists.
     * <p>
     */
...
//        }
     ...
     * Starnub will create a {@link starnub.connections.player.session.PendingPlayer} which represents a pending
...
//        });
     ...
     * Recommended: For internal use with StarNub.
     * <p>
     * Uses: This will return the connect players ConcurrentHashMap for use in direct operations.
     ...
     * Recommended: For internal use with StarNub.
     * <p>
     * Uses: This is the core method for adding a player who is actively connect to the StarNub and Starbound starbounddata.packets.starbounddata.packets.starnub.
     * <p>
     ...
     * Recommended: For internal use with StarNub.
     * <p>
     * Uses: This is the core method for removing a player who is actively connect to the StarNub and Starbound starbounddata.packets.starbounddata.packets.starnub.
     * <p>
     * @param clientCtx ChannelHandlerContext representing the client side of the starbounddata.packets.connection to be removed
     */
     ...
     * Recommended: For internal use with StarNub.
     * <p>
     * Uses: This method will add an event handler to listen for client and starbounddata.packets.starbounddata.packets.starnub disconnect starbounddata.packets. StarNub uses this
     ...
     * Recommended: For internal use with StarNub.
     * <p>
     * Uses: This method will notify the starbounddata.packets.starbounddata.packets.starnub that a player is no longer connect in order to
     ...
     * ensure that Starbound does self cleanup.
     * <p>
     * @param serverSideCTX ChannelHandlerContext that represents the starbounddata.packets.starbounddata.packets.starnub side of the client-starbounddata.packets.starbounddata.packets.starnub starbounddata.packets.connection
     */
...
//     * @param sender Sender representing who sent the query
//     * @param characterName String representing the character name that was queried
//     * @param characterId int representing the character id from utilities.cache
...
//     * Recommended: For internal use with StarNub.
//     * <p>
//     * Uses: This method well retrieve a character by name, if multiple names exist, we will utilities.cache the results
...
//     * the specific player represented by the int. The utilities.cache for this specific instance is distinguishable by the
//     * character name.
//     * <p>
//     * @param sender Sender representing who sent the query
//     * @param characterName String representing the character name that was queried
...
//            /* More then one character by this name lets utilities.cache the results so they can be displayed to the user */
...
//     * Recommended: For internal use with StarNub.
//     * <p>
//     * Uses: This method well purge any utilities.cache over the age of 10 minutes
//     * <p>
//     */
