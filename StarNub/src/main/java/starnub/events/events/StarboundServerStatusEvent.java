...
import utilities.events.types.IntegerEvent;
...
public class StarboundServerStatusEvent extends StatusEvent {
    ...
    /**
     * boolean representing that the Starbound starbounddata.packets.starbounddata.packets.starnub process connectionstatus
     */

    private volatile boolean crashed;

    /**
     * boolean representing that the Starbound starbounddata.packets.starbounddata.packets.starnub is responsive
     */

    private volatile boolean unresponsive;

    /**
     * boolean represents if the starbounddata.packets.starbounddata.packets.starnub is restarting
     */
     ...
     * @param online       boolean setting if the starbounddata.packets.starbounddata.packets.starnub is online
     */
    ...
    /**
     * Sent when the starbounddata.packets.starbounddata.packets.starnub check detects a crashed process
     */
    ...
    /**
     * Sent when the starbounddata.packets.starbounddata.packets.starnub tcp query returns unresponsive after 12 query attempts over 120 seconds
     */
    ...
    /**
     * Sent when the starbounddata.packets.starbounddata.packets.starnub is just starting up
     */
    ...
    /**
     * Sent periodically while the starbounddata.packets.starbounddata.packets.starnub is still starting up
     */
    ...
    /**
     * Sent once the starbounddata.packets.starbounddata.packets.starnub is online
     */
    ...
    /**
     * Sent when the starbounddata.packets.starbounddata.packets.starnub has responded to a process check and TCP query
     */
    public static void eventSend_Starbound_Server_Status_Responsive() {
        StarNub.getStarNubEventRouter().notify(new LongEvent("Starbound_Server_Status_Responsive", StarNub.getServerStats().getSbUptime()));
    }
    ...
    /**
     * Sent when the starbounddata.packets.starbounddata.packets.starnub was signaled to shutdown
     */
    ...
    /**
     * Sent when the starbounddata.packets.starbounddata.packets.starnub has shutdown
     */
    ...
    /**
     * Sent every time the starbounddata.packets.starbounddata.packets.starnub query attempt has failed.
     *
