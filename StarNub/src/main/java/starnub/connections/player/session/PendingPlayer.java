 ...
 * @since 1.0
 */
public class PendingPlayer extends Connection {
    ...
    /**
     * Represents the ChannelHandlerContext for the starbounddata.packets.starbounddata.packets.starnub side part of this session
     */
     ...
     * @param PLAYER_SESSION Player that represents the character trying to connect to the starbounddata.packets.starbounddata.packets.starnub
     * @param SESSION_SERVER_CTX ChannelHandlerContext representing the starbounddata.packets.starbounddata.packets.starnub side of this starbounddata.packets.connection
