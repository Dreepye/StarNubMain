...
public class StarNubEventSubscription extends EventSubscription<StarNubEvent<String>> {

    public StarNubEventSubscription(String SUBSCRIBER_NAME, EventHandler<StarNubEvent<String>> EVENT_HANDLER) {
