...
public class StarboundQueryTaskEvent extends TaskEvent {
    ...
    /**
     * Sent when the starbounddata.packets.starbounddata.packets.server query task has started. This is used to set a connectionstatus on
     * {@link server.server.starbound.OLDStarboundManager} this prevents the methods
    ...
    /**
     * Sent when the starbounddata.packets.starbounddata.packets.server query task is running. This is used to set a connectionstatus on
     * {@link server.server.starbound.OLDStarboundManager} this prevents the methods
     ...
     * {@link server.server.starbound.OLDStarboundManager} are available for use
     */
